...
function typingEffect() {
  const texts = [
    "Welcome to 2Hs skateboarding",
    "We make perfect boards",
    "We offer the best skate support",
    "Scroll down and explore more",
  ];
  let index = 0;
  let count = 0;
  let currentTxt = "";
...
function scroll() {
  document.addEventListener("scroll", () => {
    ...
    const historyImgs = document.querySelectorAll(".img-wrap");
